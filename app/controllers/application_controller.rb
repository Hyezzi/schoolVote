class ApplicationController < ActionController::Base
  ...
  # If we're on a devise page, we don't want to store that as the place to return to 
  # (for example, we don't want to return to the sign in page after signing in), which is what the :unless prevents
